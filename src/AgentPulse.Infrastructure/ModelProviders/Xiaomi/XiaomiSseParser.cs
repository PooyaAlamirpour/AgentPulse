...
public sealed class XiaomiSseParser
{
        ...
        [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
        ...
        while (true)
        {
            ...
            if (state.Done)
            {
                throw InvalidResponse(
                    "The Xiaomi MiMo stream produced an event after completion.");
            }
        ...
        {
            throw InvalidResponse(
                "The Xiaomi MiMo stream ended before the [DONE] marker.");
        }
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        catch (DecoderFallbackException exception)
        {
            throw new ModelProviderException(
                ...
                "The Xiaomi MiMo stream contained invalid UTF-8 data.",
                exception);
        }
    }
        ...
        ParserState state)
    {
        if (string.Equals(payload.Trim(), "[DONE]", StringComparison.Ordinal))
        {
            ...
            {
                throw InvalidResponse(
                    "The Xiaomi MiMo stream completed more than once.");
            }

            if (!state.FinishReasonSeen || state.FinishReason is null)
            {
                throw InvalidResponse(
                    "The Xiaomi MiMo stream ended without a finish reason.");
            }

            if (!state.TextSeen)
            {
                throw InvalidResponse(
                    "The Xiaomi MiMo stream completed without usable text output.");
            }
        ...
        catch (JsonException exception)
        {
            throw new ModelProviderException(
                ModelProviderErrorCode.InvalidResponse,
                "The Xiaomi MiMo stream contained invalid JSON.",
                exception);
        }
        ...
        using (document)
        {
            ...
            {
                throw InvalidResponse(
                    "The Xiaomi MiMo stream contained an unexpected JSON value.");
            }
            ...
            if (root.TryGetProperty("choices", out var choices))
            {
                ...
                {
                    throw InvalidResponse(
                        "The Xiaomi MiMo stream choices value was not an array.");
                }
                ...
                if (choices.GetArrayLength() > 0)
                {
                    ...
                    {
                        throw InvalidResponse(
                            "The Xiaomi MiMo stream produced a choice after its finish reason.");
                    }
            ...
            {
                throw InvalidResponse(
                    "The Xiaomi MiMo stream contained an unknown JSON event.");
            }
        ...
        ICollection<ModelStreamEvent> events)
    {
        ...
        {
            throw InvalidResponse(
                "The Xiaomi MiMo stream contained an invalid choice.");
        }
            ...
            delta.ValueKind != JsonValueKind.Null)
        {
            ...
            {
                throw InvalidResponse(
                    "The Xiaomi MiMo stream contained an invalid delta.");
            }
                ...
                HasUnsupportedToolCalls(toolCalls))
            {
                throw new ModelProviderException(
                    ...
                    "Xiaomi MiMo returned tool calls, which are not supported in this phase.");
            }
                ...
                content.ValueKind != JsonValueKind.Null)
            {
                ...
                {
                    throw InvalidResponse(
                        "The Xiaomi MiMo stream returned non-text content.");
                }
            ...
            finishReason.ValueKind != JsonValueKind.Null)
        {
            ...
            {
                throw InvalidResponse(
                    "The Xiaomi MiMo stream returned an invalid finish reason.");
            }

            if (state.FinishReasonSeen)
            {
                throw InvalidResponse(
                    "The Xiaomi MiMo stream returned more than one finish reason.");
            }
    ...
    private static ModelUsage ParseUsage(JsonElement usage)
    {
        ...
        {
            throw InvalidResponse(
                "The Xiaomi MiMo stream returned invalid usage information.");
        }
        ...
        catch (ArgumentException exception)
        {
            throw new ModelProviderException(
                ModelProviderErrorCode.InvalidResponse,
                "The Xiaomi MiMo stream returned inconsistent usage information.",
                exception);
        }
    }
